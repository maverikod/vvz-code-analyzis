...
class TestGetImports:
    ...
    async def test_get_imports(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            import1_id = db.add_import(file_id, "os", None, "import", 1)
            import2_id = db.add_import(file_id, "sys", None, "import", 2)
            import3_id = db.add_import(file_id, "pathlib", "pathlib", "import_from", 3)
            import4_id = db.add_import(file_id, "Path", "pathlib", "import_from", 4)
