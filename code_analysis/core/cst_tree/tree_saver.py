...
def save_tree_to_file(
    ...
    3. Generate source code from CST tree (with inline @node-id comments)
    ...
    with file_lock(target_path):
        ...
        try:
            ...
            source_code = restore_inline_stable_ids(tree.module, tree.metadata_map).code
            ...
            # Pass source_code with inline @node-id markers so DB tree gets same node_ids
            # as in-memory tree.
