...
'''
        ...
        config = {
            ...
            "dst_classes": {"DstClass1": {"props": ["prop1"], "methods": ["method1"]}},
        }
...
'''
        ...
        config = {
            "src_class": "SourceClass",
            "dst_classes": {
                "DstClass1": {"props": [], "methods": ["method1", "method2"]}
            },
        }
...
'''
        ...
        assert (
            "# This is a comment in class body" in content
            or "# Another comment before method" in content
        )
...
'''
        ...
        config = {
            "src_class": "SourceClass",
            "dst_classes": {"DstClass1": {"props": [], "methods": ["method1"]}},
        }
...
'''
        ...
        config = {
            "src_class": "SourceClass",
            "dst_classes": {
                "DstClass1": {"props": ["prop1"], "methods": ["method1"]},
                "DstClass2": {"props": ["prop2"], "methods": ["method2"]},
            },
        }
...
'''
        ...
        config = {
            ...
            "abstract_methods": [],
            "extract_from": {
                "Child1": {"properties": ["prop1"], "methods": ["method"]},
                "Child2": {"properties": ["prop1"], "methods": ["method"]},
            },
        }
