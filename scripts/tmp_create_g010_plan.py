"""Create the temporary G010 implementation plan document."""
...
for t in [
    "T-901-full-text-threshold",
    "T-902-module-renderer",
    "T-903-node-renderer",
    "T-904-block-integration",
]:
...
with open(f"{base}/G-010-python-node-visualizer/README.yaml", "w") as f:
    f.write(g010)
with open(
    f"{base}/G-010-python-node-visualizer/T-901-full-text-threshold/README.yaml", "w"
) as f:
    f.write(t901)
with open(
    f"{base}/G-010-python-node-visualizer/T-902-module-renderer/README.yaml", "w"
) as f:
    f.write(t902)
with open(
    f"{base}/G-010-python-node-visualizer/T-903-node-renderer/README.yaml", "w"
) as f:
    f.write(t903)
with open(
    f"{base}/G-010-python-node-visualizer/T-904-block-integration/README.yaml", "w"
) as f:
    f.write(t904)
