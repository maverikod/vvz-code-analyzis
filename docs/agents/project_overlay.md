...
- **Runtime dependency:** `mcp-proxy-adapter>=8.10.21` (help merges `get_schema()` + `metadata()` per [`standards/METADATA_SCHEMA_STANDARD.md`](../standards/METADATA_SCHEMA_STANDARD.md)).
