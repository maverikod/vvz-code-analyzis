"""
Legacy MCP command: list_projects_db (database query; not registered).

Superseded by disk-based ``list_projects``. Kept for reference and tests.
...
class ListProjectsDbLegacyMCPCommand(BaseMCPCommand):
    """
    List all projects in the database (legacy, unregistered).
    ...
    @classmethod
    def get_schema(
        cls: type["ListProjectsDbLegacyMCPCommand"],
    ) -> Dict[str, Any]:
        """
    ...
    def validate_params(
        self: "ListProjectsDbLegacyMCPCommand", params: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    @classmethod
    def metadata(cls: type["ListProjectsDbLegacyMCPCommand"]) -> Dict[str, Any]:
        """
    ...
    def _run_list_projects_sync(
        self: "ListProjectsDbLegacyMCPCommand",
