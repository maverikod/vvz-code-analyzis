...
class TestListCodeEntities:
    ...
    async def test_list_classes(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            class1_id = db.add_class(file1_id, "Class1", 10, "Class 1 docstring", ["Base1"])
            class2_id = db.add_class(file1_id, "Class2", 20, "Class 2 docstring", [])
            class3_id = db.add_class(file2_id, "Class3", 15, "Class 3 docstring", ["Base2", "Base3"])
    ...
    async def test_list_functions(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            func1_id = db.add_function(file_id, "func1", 10, ["arg1"], "Function 1")
            func2_id = db.add_function(file_id, "func2", 20, ["arg1", "arg2"], "Function 2")
    ...
    async def test_list_methods(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            method1_id = db.add_method(class_id, "method1", 15, ["self"], "Method 1")
            method2_id = db.add_method(class_id, "method2", 25, ["self", "arg1"], "Method 2", is_abstract=True)
    ...
    async def test_list_all_entities(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            file_id = db.add_file("test.py", 100, 1234567890.0, True, project_id)
            class_id = db.add_class(file_id, "TestClass", 10, "Class docstring", [])
            func_id = db.add_function(file_id, "test_func", 5, [], "Function docstring")
            method_id = db.add_method(class_id, "test_method", 15, ["self"], "Method docstring")
    ...
    async def test_list_entities_with_file_filter(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            class1_id = db.add_class(file1_id, "Class1", 10, "Class 1", [])
            class2_id = db.add_class(file2_id, "Class2", 10, "Class 2", [])
            
            # List classes in file1
            cmd = ListCodeEntitiesCommand(db, project_id, entity_type="class", file_path="file1.py")
            result = await cmd.execute()
