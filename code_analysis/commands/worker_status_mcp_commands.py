...
class ListIndexingErrorsMCPCommand(BaseMCPCommand):
    ...
    def metadata(cls: type["ListIndexingErrorsMCPCommand"]) -> Dict[str, Any]:
        ...
        This method provides comprehensive information about the command,
        including detailed descriptions, usage examples, and edge cases.
        The metadata is as detailed and clear as a man page.
        ...
        return {
            ...
            "parameters": {
                ...
                "project_id": {
                    "description": (
                        "Optional. Only errors for this project UUID. Use list_projects to get IDs."
                    ),
                    "type": "string",
                    "required": False,
                },
                    ...
                    "examples": [
                        {
                            ...
                            "message": "Error connecting to database",
                            "solution": (
                                "Verify server config and database path. "
                                "Use get_database_status to check DB availability."
                            ),
                        },
                        {
                            ...
                            "message": "Error executing query",
                            "solution": (
                                "If table exists but query fails, check schema. "
                                "Missing table returns success with table_missing: true, not this error."
                            ),
                        },
                    ],
                },
            ...
            "return_value": {
                "success": {
                    ...
                    "data": {
                        ...
                        "list": (
                            "Array of objects: id, project_id, file_path, error_type, error_message, created_at"
                        ),
                        "table_missing": (
                            "Optional. Present and true only when indexing_errors table does not exist"
                        ),
                    },
                    "example": {
                        "total": 2,
