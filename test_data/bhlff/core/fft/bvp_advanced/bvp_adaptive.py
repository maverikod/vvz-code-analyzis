...
class BVPAdaptive:
    ...
    def _solve_linear_system_adaptive(
        ...
        Physical Meaning:
            Solves the linear system J·δa = r for adaptive iteration,
    ...
    def _compute_adaptive_step_size(
        ...
        Physical Meaning:
            Computes optimal step size for adaptive iteration based on
            update magnitude and residual behavior.
