...
2. Добавить валидацию JSON структуры
3. Обеспечить обратную совместимость (поддержка старого формата)
4. Обновить тесты
...
**Риск 1**: Обратная совместимость со старым форматом projectid
- **Митигация**: Поддержка обоих форматов в `load_project_id()`
