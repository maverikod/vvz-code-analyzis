...
- ✅ Simple additions (new functions, classes)
- ✅ Test files and utilities
- ✅ Code that will be auto-formatted anyway

**Example**:
```python
# ✅ CORRECT: Creating new module
compose_cst_module(
...
- ✅ Replacing methods/functions in existing files
- ✅ Refactoring operations
- ✅ When preserving comments/formatting is critical
- ✅ Precise block replacements using selectors

**Example**:
```python
# ✅ CORRECT: Replacing existing method
compose_cst_module(
...
1. **New code** → Write directly
2. **Existing code** → Use CST with selectors
3. **Complex refactoring** → Use specialized commands (`split_class`, `split_file_to_package`)
...
- ✅ Use CST for existing code modifications
- ✅ Write code directly for new modules
...
- **New code** → Write directly
- **Existing code** → Use CST
