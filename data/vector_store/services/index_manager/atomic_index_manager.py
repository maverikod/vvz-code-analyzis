...
индексов через LUA скрипты с пятичастной структурой."""
    def __init__(self):
        self.atomicindexoperations = AtomicIndexOperations()
        self.atomicindexcache = AtomicIndexCache()
    def index_chunk(self, chunk, validate):
        return self.atomicindexoperations.index_chunk(chunk, validate)
    def delete_chunk(self, uuid, soft):
        return self.atomicindexoperations.delete_chunk(uuid, soft)
    def soft_delete_chunk(self, uuid, reason):
        return self.atomicindexoperations.soft_delete_chunk(uuid, reason)
    def hard_delete_chunk(self, uuid):
        return self.atomicindexoperations.hard_delete_chunk(uuid)
    def restore_chunk(self, uuid):
        return self.atomicindexoperations.restore_chunk(uuid)
    def cleanup_chunk(self, uuid):
        return self.atomicindexoperations.cleanup_chunk(uuid)
    def check_chunk_exists(self, uuid):
        return self.atomicindexoperations.check_chunk_exists(uuid)
    def remove_vector_by_index(self, faiss_index):
        return self.atomicindexoperations.remove_vector_by_index(faiss_index)
    def create_index(self, field_name, index_type):
        return self.atomicindexoperations.create_index(field_name, index_type)
    def get_index_stats(self, uuid):
        return self.atomicindexoperations.get_index_stats(uuid)
    def get_field_statistics(self):
        return self.atomicindexoperations.get_field_statistics()
    def search_by_chunk_query(self, chunk_query, limit, offset):
        return self.atomicindexoperations.search_by_chunk_query(chunk_query, limit, offset)
    def set_chunk_metadata_adapter(self, adapter):
        return self.atomicindexoperations.set_chunk_metadata_adapter(adapter)
    def _analyze_field_types(self, chunk_data):
        return self.atomicindexfieldanalysis._analyze_field_types(chunk_data)
    def _determine_field_type(self, field_name, value):
        return self.atomicindexfieldanalysis._determine_field_type(field_name, value)
    def _determine_index_type(self, field_name, value, field_type):
        return self.atomicindexfieldanalysis._determine_index_type(field_name, value, field_type)
    def _should_index_field(self, field_name, value, field_type):
        return self.atomicindexfieldanalysis._should_index_field(field_name, value, field_type)
    def _extract_field_metadata(self, field_name, value, field_type):
        return self.atomicindexfieldanalysis._extract_field_metadata(field_name, value, field_type)
    def _is_date_string(self, value):
        return self.atomicindexfieldanalysis._is_date_string(value)
    def _generate_replace_chunk_script(self, field_analysis):
        return self.atomicindexscriptgeneration._generate_replace_chunk_script(field_analysis)
    def _generate_scalar_index_script(self, field_info):
        return self.atomicindexscriptgeneration._generate_scalar_index_script(field_info)
    def _generate_text_index_script(self, field_info):
        return self.atomicindexscriptgeneration._generate_text_index_script(field_info)
    def _generate_number_index_script(self, field_info):
        return self.atomicindexscriptgeneration._generate_number_index_script(field_info)
    def _generate_date_index_script(self, field_info):
        return self.atomicindexscriptgeneration._generate_date_index_script(field_info)
    def _generate_array_index_script(self, field_info):
        return self.atomicindexscriptgeneration._generate_array_index_script(field_info)
    def _generate_field_specific_script(self, field_analysis):
        return self.atomicindexscriptgeneration._generate_field_specific_script(field_analysis)
    def _prepare_script_parameters(self, uuid, chunk_data):
        return self.atomicindexscriptgeneration._prepare_script_parameters(uuid, chunk_data)
    def _execute_replace_script(self, uuid, script, chunk_data):
        return self.atomicindexscriptgeneration._execute_replace_script(uuid, script, chunk_data)
    def _generate_script_key(self, field_analysis):
        return self.atomicindexscriptgeneration._generate_script_key(field_analysis)
    def _validate_chunk_data(self, uuid, chunk_data):
        return self.atomicindexvalidation._validate_chunk_data(uuid, chunk_data)
    def _get_script_sha(self):
        return self.atomicindexcache._get_script_sha()
    def clear_cache(self):
        return self.atomicindexcache.clear_cache()
    def _handle_index_error(self, uuid, chunk_data, error):
        return self.atomicindexerrorhandling._handle_index_error(uuid, chunk_data, error)
    def _rollback_index_operation(self, uuid):
        return self.atomicindexerrorhandling._rollback_index_operation(uuid)
class AtomicIndexOperations:
    """Менеджер атомарных операций с индексами.
...
индексов через LUA скрипты с пятичастной структурой."""
    def __init__(self):
        ...
        self.chunk_metadata_adapter = None
        self.embedding_service = None
        self.chunk_query_support = None
...
class AtomicIndexFieldAnalysis:
    """Менеджер атомарных операций с индексами.
...
индексов через LUA скрипты с пятичастной структурой."""
    ...
    def _is_date_string(self, value: str) -> bool:
        ...
        return False
class AtomicIndexScriptGeneration:
    """Менеджер атомарных операций с индексами.
...
class AtomicIndexErrorHandling:
    """Менеджер атомарных операций с индексами.
