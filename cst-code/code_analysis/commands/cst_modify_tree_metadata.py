"""
Metadata for cst_modify_tree MCP command (AI/help).
...
CMD_CATEGORY = "cst"
CMD_AUTHOR = "Vasiliy Zdanovskiy"
CMD_EMAIL = "vasilyvz@gmail.com"


def get_cst_modify_tree_metadata() -> Dict[str, Any]:
    """
            ...
            "operations": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "code": {
                            "description": "New code for replace/insert (single string). Prefer code_lines for multi-line.",
                            "type": "string",
                        },
                        "code_lines": {
                            "description": "New code as list of lines (recommended for multi-line).",
                            "type": "array",
                            "items": {"type": "string"},
                        },
                        "position": {
                        ...
                        "parent_node_id": {
                            "description": "Parent node ID for insert (alternative to target_node_id)",
                            "type": "string",
                        },
                        "target_node_id": {
                            "description": "Target node ID for insert (before/after this node)",
                            "type": "string",
                        },
                    },
                },
        ...
        "usage_examples": [
            ...
            },
            {
                ...
                "command": {
                    "tree_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
                    "operations": [
                        {"action": "delete", "node_id": "smallstmt:Pass:15:4-15:8"}
                    ],
                },
                "explanation": (
