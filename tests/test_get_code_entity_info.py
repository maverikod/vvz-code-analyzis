...
class TestGetCodeEntityInfo:
    ...
    async def test_get_class_info(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            class_id = db.add_class(
                file_id, "TestClass", 10, "Test class docstring", ["BaseClass"]
            )

            # Add methods
            db.add_method(
                class_id, "method1", 15, ["self", "arg1"], "Method 1 docstring"
            )
            db.add_method(
                class_id,
                "method2",
    ...
    async def test_get_function_info(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            func_id = db.add_function(
                file_id, "test_function", 20, ["arg1", "arg2"], "Function docstring"
            )
    ...
    async def test_get_method_info(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            method_id = db.add_method(
                class_id, "test_method", 15, ["self", "arg1"], "Method docstring"
            )
    ...
    async def test_get_entity_with_file_path(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            db.add_class(file2_id, "SameName", 10, "Class 2", [])

            # Get class from file1
            cmd = GetCodeEntityInfoCommand(
                db, project_id, "class", "SameName", file_path="file1.py"
            )
            result = await cmd.execute()
    ...
    async def test_get_entity_with_line(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            db.add_function(file_id, "same_name", 10, [], "Function 1")
            func2_id = db.add_function(file_id, "same_name", 20, [], "Function 2")

            # Get function at line 20
            cmd = GetCodeEntityInfoCommand(
                db, project_id, "function", "same_name", line=20
            )
            result = await cmd.execute()
