# Step 06: list_watch_dirs use shared database
...
- **Target code file:** `code_analysis/commands/project_management_mcp_commands/list_watch_dirs.py`
- **Step type:** Refactor command to use shared DB
- **Primary purpose:** list_watch_dirs must use the long-lived connection instead of opening its own.
...
- `code_analysis/commands/project_management_mcp_commands/list_watch_dirs.py` (full execute path)
...
- list_watch_dirs uses the shared database for its entire execute path; no per-call connection open.

---

## Mandatory validation

- From project root: `black code_analysis/commands/project_management_mcp_commands/list_watch_dirs.py`, `flake8 code_analysis/commands/project_management_mcp_commands/list_watch_dirs.py`, `mypy code_analysis/commands/project_management_mcp_commands/list_watch_dirs.py`, then `pytest`. All tests must pass.
