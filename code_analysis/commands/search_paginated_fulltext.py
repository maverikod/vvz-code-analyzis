...
def normalize_fulltext_finding(raw: dict[str, Any], *, index: int) -> dict[str, Any]:
    ...
    ``raw`` (both the per-project and global-mode backend SELECTs already
    ...
    return {
        ...
        "score": raw.get("bm25_score") or raw.get("bm25") or raw.get("rank"),
        "text": str(raw.get("chunk_text") or raw.get("content") or ""),
