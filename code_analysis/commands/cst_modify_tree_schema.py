            ...
            "operations": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "replacements": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    "selector": {
                                        "type": "string",
                                        "description": "CSTQuery selector string (alternative to node_id)",
                                    },
                                    "node_id": {
                                        "type": "string",
                                        "description": "UUID4 node_id (alternative to selector, from cst_find_node)",
                                    },
                                ...
                                "description": (
                                    "For replace_many: provide either selector (CSTQuery) or "
                                    "node_id (UUID4) plus code/code_lines per replacement."
                                ),
                            },
                            "description": (
                        ...
                        "replace_all_child_nodes": {
                            "type": "boolean",
                            "description": (
                                "For replace action on ClassDef/FunctionDef: when false (default) "
                                "only the header is replaced (name, bases, decorators, params, returns) "
                                "and the body is preserved. When true, the entire node including "
                                "its body is replaced (legacy behaviour)."
                            ),
                        },
                    },
                    "required": ["action"],
