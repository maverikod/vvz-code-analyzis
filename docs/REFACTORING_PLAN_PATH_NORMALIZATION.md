...
5. **Этап 3.5.1** - Обновить `config.py` для использования SettingsManager (критично) ⚠️
6. **Этап 4** - Менеджер проектов с git (управление) ✅
7. **Этап 5** - Унификация нормализации (централизация) ⚠️
8. **Этап 5.1** - Полностью исключить старые методы нормализации (первоочередная задача) ⚠️
...
15. **Этап 12** - Документация (финализация) ⚠️
