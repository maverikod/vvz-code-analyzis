...
''',
        ...
        try:
            ...
            if project_after:
                print("   ERROR: Project record still exists!")
                return False
            else:
            ...
            if vector_count_after > 0:
                print(
                    f"   ERROR: {vector_count_after} vector index entries still in database!"
                )
                return False
            else:
            ...
            if project_exists > 0:
                print("   ERROR: Project ID still exists in projects table!")
                return False
            else:
